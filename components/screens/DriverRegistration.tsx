          ...
          <View style={styles.documentsSection}>
            ...
            <View style={styles.documentsList}>
              <TouchableOpacity style={styles.documentButton}>
                ...
                <Text style={styles.documentText}>Carte d'identité (CNI)</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.documentButton}>
                <Ionicons name="cloud-upload" size={20} color="#6b7280" />
                <Text style={styles.documentText}>Permis de conduire</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.documentButton}>
                <Ionicons name="cloud-upload" size={20} color="#6b7280" />
                <Text style={styles.documentText}>Carte grise du véhicule</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.documentButton}>
                <Ionicons name="cloud-upload" size={20} color="#6b7280" />
                <Text style={styles.documentText}>Assurance du véhicule</Text>
              </TouchableOpacity>
            </View>
          </View>
